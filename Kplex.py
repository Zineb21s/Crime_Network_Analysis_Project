...
from bib import createSubGraph
...
if __name__ == "__main__":
    ...
    G = createSubGraph(nodes, 'yellowgreen')

    nx.draw(G, with_labels=True, font_size=6, node_color='yellowgreen', node_size=10)
    plt.axis('off')
